 ...
 * vital to the components functionality. It differs from props because
 ...
 * components state but state is meant to be maintained by the component
 * itself.
 *
 * Notice the creation of the state in the constructor. The state
 * needs to be initialized with all properties before the component
 * is mounted, during its creation.
 *
