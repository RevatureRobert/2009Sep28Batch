 ...
 * 		and working with our orm (hibernate). It does a 	
 *		few things for us. 
 *
 ...
 *
 *		#2 it
 *		provides funtionality for generating unwritten methods
 *		with sql queries based on the names of the custom names
 *		provided.
 *
 */
@Repository
