...
insert into b values (2,'hey'),(3,'look'),(4,'over here');

--union
select * from a union select number_b from b; --not, can't do select * or select string.  Have to have same datatype and number of rows operated on
...
select number_b from b except select * from a;