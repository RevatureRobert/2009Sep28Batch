...
public class DataTypes {
	 ...
	 * 		-2^(NumberOfBits-1) to 2^(NumberOfBits)-1
	*/
	public static void main(String[] args) {
		...
		//int i = 6;
		short i = 6;
		//short answer = s1 + i; does not work
		
		/*
		 * when performing operations on two different sized data types, it will bring them up to the amount of the larger one, with 32 bit being the minimum
		 */
		 ...
		 * 		the varable holds a reference to where teh object is held.
		 */
		Object o = new Object();
