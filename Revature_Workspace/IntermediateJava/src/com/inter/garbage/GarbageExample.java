...
/*
 * Garbage Collection
 * 		The Garbage Collector wil clean unreferenced objects out of the heap. 
 * 		Garbage Collector does not remove references from the stack.
 * 
 ...
 * 			The purpose of the finalize method is to give last minute instructions
 * 			to the object.
 * 
 * 		If you need something done at the end of the program, do not rely on the
 * 			finalize method, it is better put in the finally block.
 * 
 * */
...
//		r4 = null;
//		r5 = null;
		System.gc(); // Cannot force gc, but you can request it
//		Thread.sleep(2000);
		RandomObject r11 = new RandomObject();
		RandomObject r12 = new RandomObject();
		RandomObject r13 = new RandomObject();
